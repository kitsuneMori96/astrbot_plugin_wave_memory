...
class WaveMemoryDB:
    ...
    def add_memory(self, group_id, content, vector=None, sender_id="", sender_name="", timestamp=None, importance=1.0, source="live", quantize=True):
        return self._memory_repo.add_memory(group_id, content, vector, sender_id, sender_name, timestamp, importance, source, quantize=quantize)
