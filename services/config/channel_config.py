...
def build_default_channel_config(
    *,
    ...
    defaults = {
        ...
        "book_lore": ChannelConfig("book_lore", _enabled_for("book_lore", mode, inject_cfg), priority=45, max_items=1, token_budget=260, timeout_ms=300, min_score=0.35, modes=_modes_for("book_lore", mode)),
